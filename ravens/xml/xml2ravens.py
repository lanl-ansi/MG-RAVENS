        ...
        for obj_id, obj in template.get("properties", {}).items():
            try:
                if obj.get("type", None) == "array":
                    ...
                    # is a primitive json type, nothing to do
                    pass
...
if __name__ == "__main__":
    ...
    d.dump(MGR_ROOT+"/examples/IEEE13_Assets.json", indent=2)

    #Creation of Simplified MG-RAVENS File from xml
    d2 = CrowsImport(MGR_ROOT+"/examples/IEEE13_Assets.xml")
    d2.dump(MGR_ROOT+"/examples/IEEE13_Assets_simplified.json", indent=2)
