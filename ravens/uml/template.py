...
inclusions = clusions.get_inclusions(uml_data, package='SimplifiedDiagrams')
ug = graph.UMLGraphsEnhanced(uml_data=uml_data, inclusions=inclusions)
G = ug.graph

mv = ModelValidator(ug.graph, root_name="Root")
