...
class TemplateCompare:
    ...
    Defaults:
      ...
      • Loads auto from ravens/lib/template_auto.json (resolved locally)
    ...
    def __init__(self,
        ...
        self.auto_schema, self.auto_path = self._coerce_schema(auto, default_path=_default_template_auto_path())
