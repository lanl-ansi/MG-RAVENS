...
class SimpleGNN(nn.Module):
    ...
    def __init__(
        ...
        # Row‑wise soft‑max (each row of the matrix sums to 1)
    ...
    def forward(self, data):
        ...
        Returns
        -------
        adj : Tensor of shape (B, max_nodes, max_nodes)
        ...
        # --------------------------------------------------------------
        logits = self.edge_mlp(edge_rep)                     # (E, max_nodes²)

        # --------------------------------------------------------------
        # Reshape to a square matrix per edge (or per graph in a batch)
        # --------------------------------------------------------------
        ...
        # Row‑wise soft‑max
        # --------------------------------------------------------------
        adj = self.row_softmax(logits)  # shape (B, max_nodes, max_nodes)
